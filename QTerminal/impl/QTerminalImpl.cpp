...
void QTerminalImpl::findText(const QString& searchStr, const bool caseSensitive, const bool searchUp)
{
    _terminalView->findText(searchStr, caseSensitive, searchUp);
}
