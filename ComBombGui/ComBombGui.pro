...
else:win32:CONFIG(debug, debug|release):  LIBS += -L$$PWD/../../botan/install/lib/botan/debug   -lbotand -lCDLoggerd -lcppsshd
...
else:win32:CONFIG(debug, debug|release):  PRE_TARGETDEPS += $$PWD/../../install/lib/cppsshd.lib  $$PWD/../../install/lib/CDLoggerd.lib  $$PWD/../../botan/install/lib/botan/debug/botand.lib
